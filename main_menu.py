...
class MainMenu(Scene):
    def __init__(self, game) -> None:
        ...
        self.game.graphics.primary_surface = pygame.Surface(self.double_screen_dims)

        background_size = self.double_screen_dims * 1.2
        self.background = pygame.transform.scale(
            self.game.images.main_menu_background,
        ...
        self.title_shadow.fill((0, 0, 0), special_flags=pygame.BLEND_RGBA_MULT)
    ...
    def draw(self):
        ...
        background_x = 0.3 * math.sin(self.game.time * 0.0013) * offset - offset * 1.5
